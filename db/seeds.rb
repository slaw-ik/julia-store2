...
ActiveRecord::Base.transaction do
  ...
  address3 = Address.create!(country: 'UA', street: 'Street 3', city: 'City 3', region: 'Region 3', building: 'Building 3')

  client1 = Client.create!(nickname: 'Client_1', first_name: 'Name 1', last_name: 'Last 1', address: address1, email: 'client@one.com', phone: '1234567890')
